...
function multiply(a, b) { //eslint-disable-line
  let multiPly = a * b;
  let multiString = `The product of ${a} and ${b} is ${multiPly}.`;

  return [multiPly, multiString];
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let stringStrung = `2,3,4 was passed in as an array of numbers, and ${totalSum} is their sum.`;

  return [totalSum,stringStrung];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  let firstMulti = multiply(multArr[0], multArr[1])[0];
  let totalMulti = multiply(multArr[2], firstMulti)[0];
  let strungString = `The numbers 2,3,4 have a product of ${totalMulti}.`;
  
  return [totalMulti, strungString];
}
